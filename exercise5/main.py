...
if __name__ == '__main__':
    ...
    # ORG_DIR         = '/SLI-KUBE-WORK/KubeSec-master/TEST_ARTIFACTS/'
    # OUTPUT_FILE_CSV = '/SLI-KUBE-WORK/DEMO-OUTPUT.csv'

    ORG_DIR         = '/SLI-KUBE-WORK/KubeSec-master/e5/K8S_ARTIFACTS/'
    OUTPUT_FILE_CSV = '/SLI-KUBE-WORK/EXERCISE5-OUTPUT.csv'
